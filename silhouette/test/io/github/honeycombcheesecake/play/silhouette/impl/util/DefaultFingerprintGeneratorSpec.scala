...
import io.github.honeycombcheesecake.play.silhouette.api.crypto.Hash
import play.api.test.{ FakeRequest, PlaySpecification }

/**
 * Test case for the [[io.github.honeycombcheesecake.play.silhouette.impl.util.DefaultFingerprintGenerator]] class.
 */

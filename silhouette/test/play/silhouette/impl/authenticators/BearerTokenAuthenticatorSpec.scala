...
import play.silhouette.api.util.{ RequestPart, Clock, IDGenerator }
import play.silhouette.impl.authenticators.BearerTokenAuthenticatorService._
...
/**
 * Test case for the [[play.silhouette.impl.authenticators.BearerTokenAuthenticator]].
 */

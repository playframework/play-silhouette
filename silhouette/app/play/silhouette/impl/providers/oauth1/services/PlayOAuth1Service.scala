...
import play.silhouette.impl.providers.oauth1.services.PlayOAuth1Service._
import play.silhouette.impl.providers.{ OAuth1Info, OAuth1Service, OAuth1Settings }

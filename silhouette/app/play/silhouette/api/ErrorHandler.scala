...
trait NotAuthenticatedErrorHandler extends ErrorHandler {
  ...
  /**
   * Exception handler which translates an [[play.silhouette.api.exceptions.NotAuthenticatedException]]
...
trait NotAuthorizedErrorHandler extends ErrorHandler {
  ...
  /**
   * Exception handler which translates an [[play.silhouette.api.exceptions.NotAuthorizedException]]

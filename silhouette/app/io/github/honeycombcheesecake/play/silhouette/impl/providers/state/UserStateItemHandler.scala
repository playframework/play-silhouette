...
import io.github.honeycombcheesecake.play.silhouette.impl.providers.{ SocialStateItem, SocialStateItemHandler }
...
class UserStateItemHandler[S <: SocialStateItem](item: S)(
  implicit
  format: Format[S],
  classTag: ClassTag[S]) extends SocialStateItemHandler {

 ...
 */
package io.github.honeycombcheesecake.play.silhouette.impl.providers.openid
...
import io.github.honeycombcheesecake.play.silhouette.impl.providers.openid.SteamProvider._
...
class SteamProvider(
   ...
   */
  override def withSettings(f: Settings => Settings): SteamProvider = {

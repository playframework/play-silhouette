...
import io.github.honeycombcheesecake.play.silhouette.impl.providers.oauth2.VKProvider._
...
object VKProvider {
  ...
  implicit val infoReads: Reads[OAuth2Info] = (
    ...
    (__ \ "email").readNullable[String])((accessToken: String, tokenType: Option[String], expiresIn: Option[Int], refreshToken: Option[String], email: Option[String]) =>

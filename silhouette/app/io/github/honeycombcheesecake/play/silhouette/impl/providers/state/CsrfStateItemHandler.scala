 ...
 */
package io.github.honeycombcheesecake.play.silhouette.impl.providers.state
...
import io.github.honeycombcheesecake.play.silhouette.api.util.{ ExtractableRequest, IDGenerator }
import io.github.honeycombcheesecake.play.silhouette.impl.exceptions.OAuth2StateException
...
import io.github.honeycombcheesecake.play.silhouette.impl.providers.{ PublishableSocialStateItemHandler, SocialStateItem, SocialStateItemHandler }
...
class CsrfStateItemHandler @Inject() (
  ...
  signer: Signer) extends SocialStateItemHandler with Logger

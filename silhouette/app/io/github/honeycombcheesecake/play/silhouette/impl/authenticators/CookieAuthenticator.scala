...
import io.github.honeycombcheesecake.play.silhouette.api.crypto.{ AuthenticatorEncoder, Signer }
...
class CookieAuthenticatorService(
  ...
  clock: Clock)(
  implicit
  val executionContext: ExecutionContext) extends AuthenticatorService[CookieAuthenticator] with Logger {

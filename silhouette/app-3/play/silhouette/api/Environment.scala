...
import play.silhouette.api.util.ExecutionContextProvider
 ...
 * [[play.silhouette.api.services.IdentityService]] and the
 * [[play.silhouette.api.services.AuthenticatorService]] are bound to the appropriate types

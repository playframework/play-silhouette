...
import io.github.honeycombcheesecake.play.silhouette.api.util.{ PasswordHasherRegistry, PasswordInfo, _ }
import io.github.honeycombcheesecake.play.silhouette.api.{ AuthInfo, LoginInfo, _ }
import io.github.honeycombcheesecake.play.silhouette.impl.providers.GoogleTotpProvider._
...
class GoogleTotpProvider @Inject() (injectedPasswordHasherRegistry: PasswordHasherRegistry)(
  implicit
  val executionContext: ExecutionContext) extends Provider with ExecutionContextProvider with Logger {

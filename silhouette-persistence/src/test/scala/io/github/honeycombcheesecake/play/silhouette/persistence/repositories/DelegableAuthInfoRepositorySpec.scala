 ...
 */
package io.github.honeycombcheesecake.play.silhouette.persistence.repositories
...
import io.github.honeycombcheesecake.play.silhouette.impl.providers.{ OAuth1Info, OAuth2Info }
import io.github.honeycombcheesecake.play.silhouette.persistence.daos.{ DelegableAuthInfoDAO, InMemoryAuthInfoDAO }
import io.github.honeycombcheesecake.play.silhouette.persistence.repositories.DelegableAuthInfoRepository._
...
class DelegableAuthInfoRepositorySpec(implicit ev: ExecutionEnv)
  ...
  trait Context extends Scope {
     ...
     * The Guice module.
     *
     * This is to test if the [[io.github.honeycombcheesecake.play.silhouette.persistence.daos.DelegableAuthInfoDAO]] can be used for

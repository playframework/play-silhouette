 ...
 */
package io.github.honeycombcheesecake.play.silhouette.persistence.daos
 ...
 *
 * This abstract implementation of the [[io.github.honeycombcheesecake.play.silhouette.persistence.daos.AuthInfoDAO]] trait
 * allows us to get the class tag of the auth info it is responsible for. Based on the class tag
 * the [[io.github.honeycombcheesecake.play.silhouette.persistence.repositories.DelegableAuthInfoRepository]] class

 ...
 *
 * This abstract implementation of the [[play.silhouette.persistence.daos.AuthInfoDAO]] trait
 * allows us to get the class tag of the auth info it is responsible for. Based on the class tag
 * the [[play.silhouette.persistence.repositories.DelegableAuthInfoRepository]] class
